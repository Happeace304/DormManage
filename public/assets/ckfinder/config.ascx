...
<%@ Import Namespace="TNTN.Common" %>
<%@ Import Namespace="TNTN.Database.Schema" %>
...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        if (tk.IdGroup == (int)TNTN.Common.Enum.ConstantsEnum.GroupEnum.Admin)
        {
            return true;
        }
        if (!XacThuc.CheckAuthentication(new string[] { HanhDong.DEN_TRANG_THEM_CAU_HOI, HanhDong.TAO_CAU_HOI, HanhDong.DEN_TRANG_SUA_CAU_HOI, HanhDong.UPDATE_CAU_HOI }))
        {
            return false;
        }
        return true;
